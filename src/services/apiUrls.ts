const ServerBaseUrl =
  "https://nfqkh7w0bd.execute-api.ap-south-1.amazonaws.com/develop/";
...
export const DesignImageApiUrl = (designId: string) =>
  ServiceAPIUrl + "/design/image" + `?designId=${designId}`;
